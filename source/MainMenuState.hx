...
class MainMenuState extends MusicBeatState
{
    ...
    public static var modVer:String = "1.1";
	...
	override function create()
	{
		...
		FlxG.camera.follow(camFollow, null, 0.2 * (60 / FlxG.save.data.fpsCap));

		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, gameVer + " FNF - " + (Main.watermarks ? kadeEngineVer + " KE - " : "") + modVer + " Mod Ver.", 12);
